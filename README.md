...
pixi global install libblasfeo
```
...
It is possible to list all of the versions of `libblasfeo` available on your platform:
...
```
pixi search libblasfeo --channel conda-forge
```
